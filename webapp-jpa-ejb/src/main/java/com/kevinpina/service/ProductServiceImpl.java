...
@Servicio
//@TransactionalJPA 	// Does not apply with EJB due to the methods are Transactional
@Stateless				// If we remove this .commit won't work "Transactions". We can use @Statefull with Scope or context such as @RequestScope
